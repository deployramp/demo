...
import { useFlag, displayFeedback } from '@deployramp/sdk';
...
export function MetaBar({ view, onViewChange, projectName, sprint, taskCount, searchQuery, onSearchChange, sortBy = "manual", onSortChange = () => {} }: MetaBarProps) {
              ...
              {sortOptions.map((opt) => (
                <button
                  ...
                  onClick={() => {
                    ...
                    displayFeedback('task-sorting', 'How was the task sorting experience?');
                    setSortOpen(false);
                  }}
